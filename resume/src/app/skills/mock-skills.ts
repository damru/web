...
export const SKILLS: Skill[] = [
    { id: 1, name: 'UML / Merise', levelBase100: 100, order: 0, categoryId: 1 },
    ...
    { id: 6, name: 'DevOps', levelBase100: 60, order: 0, categoryId: 1 },
    { id: 7, name: 'Java', levelBase100: 95, order: 0, categoryId: 2 },
    { id: 8, name: 'Spring / Spring Boot', levelBase100: 90, order: 0, categoryId: 2 },
    { id: 9, name: 'Hibernate / JPA', levelBase100: 90, order: 0, categoryId: 2 },
    { id: 10, name: 'C / C++', levelBase100: 25, order: 0, categoryId: 2 },
    { id: 11, name: 'PHP', levelBase100: 80, order: 0, categoryId: 2 },
    { id: 12, name: 'HTML', levelBase100: 100, order: 0, categoryId: 2 },
    { id: 13, name: 'CSS', levelBase100: 90, order: 0, categoryId: 2 },
    { id: 14, name: 'JavaScript', levelBase100: 75, order: 0, categoryId: 2 },
    { id: 15, name: 'Angular', levelBase100: 20, order: 0, categoryId: 2 },
    { id: 16, name: 'Bootstrap', levelBase100: 40, order: 0, categoryId: 2 },
    { id: 17, name: 'Python', levelBase100: 20, order: 0, categoryId: 2 },
    ...
    { id: 22, name: 'Docker', levelBase100: 40, order: 0, categoryId: 3 },
    { id: 23, name: 'Jenkins, Maven, Sonar', levelBase100: 85, order: 0, categoryId: 3 },
    { id: 24, name: 'Unix', levelBase100: 90, order: 0, categoryId: 4 },
    { id: 25, name: 'Windows', levelBase100: 90, order: 0, categoryId: 4 },
    { id: 26, name: 'MySQL, T/SQL, PostgreSQL', levelBase100: 95, order: 0, categoryId: 5 }
];
